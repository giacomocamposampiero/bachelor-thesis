\documentclass[a4paper,12pt,parskip=half]{book}
...
\begin{titlepage}
	...
	\includegraphics[scale=0.35]{source-images/unipd-bn.eps} \\ % \hfill \includegraphics[scale=0.2]{source-images/logo_dei.pdf}\\
	\vspace{0.4cm}
...
\clearpage{\pagestyle{plain}\cleardoublepage} % inizia il nuovo capitolo su di una pagina dispari
\chapter{Presentazione delle sperimentazioni} % nome capitolo
